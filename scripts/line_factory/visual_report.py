...
def build_visual_report(project: Project) -> str:
    ...
    text = "\n".join(
        [
            ...
            "",
            "Review `contact_sheet.png` and `visual_report.png` for readability, expression balance, typos, background removal, character consistency, and review-risk concerns.",
            "",
            ...
            generation_gate,
            "- For repeated-character packs, compare every item against `reports/character_consistency_qa.md` and the approved model sheet before HAG-5.",
