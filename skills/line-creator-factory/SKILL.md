...
3. Stop at HAG-1 through HAG-5 until human approval is recorded in `project.yml`; use `approvals.md` for human-readable notes.
...
Never mark a project READY when validation has fatal errors, required approvals are pending, or rights/review risk is unresolved.
