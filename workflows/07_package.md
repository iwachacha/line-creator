...
Packaging proves technical upload structure only. Before calling a packaged project ready for manual upload, run:

```powershell
python -m line_factory.cli market-audit --project projects/<name>
```

If `market-audit` fails, do not upload the ZIP; revise the character, item communication plan, text system, and final artwork.
